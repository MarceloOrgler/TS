...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{dados} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{readRDS}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{dados.rds\PYZdq{}}\PY{p}{)}
\PY{n}{fit} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{StructTS}\PY{p}{(}\PY{n}{dados}\PY{o}{\PYZdl{}}\PY{n}{vetor1}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{level\PYZdq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{T2_FK_files/T2_FK_17_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Estimated Observation Noise Variance (sigma\^{}2\_epsilon): 4
Estimated State Noise Variance (sigma\^{}2\_eta): 1
    \end{Verbatim}
...
\PY{n}{sigma2\PYZus{}epsilon} \PY{o}{\PYZlt{}\PYZhy{}} \PY{l+m}{4}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{T2_FK_files/T2_FK_46_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\textcolor{ansi-blue}{<ts>}. Defaulting to continuous.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{T2_FK_files/T2_FK_47_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Estimated Observation Noise Variance (sigma\^{}2\_epsilon): 4.028132
Estimated State Noise Variance (sigma\^{}2\_eta): 1.495563
Estimated State Noise Variance (sigma\^{}2\_qsi): 0.003680569
    \end{Verbatim}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{T2_FK_files/T2_FK_63_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{y\PYZus{}mnl} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{simul\PYZus{}y\PYZus{}mnl}\PY{p}{(}\PY{n+nb+bp}{T}\PY{o}{=}\PY{n+nb+bp}{T}\PY{p}{,}\PY{l+m}{10}\PY{p}{,}\PY{l+m}{0.5}\PY{p}{,}\PY{l+m}{1}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{T2_FK_files/T2_FK_100_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{T2_FK_files/T2_FK_103_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
W = 0.99154, p-value = 0.787
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
media\_residuos: -0.02388998
var\_residuos: 0.9994234
    \end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n+nf}{length}\PY{p}{(}\PY{n}{sigma\PYZus{}epsilon2\PYZus{}vals}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n+nf}{length}\PY{p}{(}\PY{n}{sigma\PYZus{}eta2\PYZus{}vals}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n+nf}{dim}\PY{p}{(}\PY{n}{likelihood\PYZus{}matrix}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n+nf}{expand.grid}\PY{p}{(}\PY{n+nf}{c}\PY{p}{(}\PY{l+m}{1}\PY{p}{,}\PY{l+m}{2}\PY{p}{)}\PY{p}{,}\PY{n+nf}{c}\PY{p}{(}\PY{l+m}{10}\PY{p}{,}\PY{l+m}{20}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n}{fig} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{plot\PYZus{}ly}\PY{p}{(}
  \PY{n}{x} \PY{o}{=} \PY{n+nf}{unique}\PY{p}{(}\PY{n}{likelihood\PYZus{}df}\PY{o}{\PYZdl{}}\PY{n}{sigma\PYZus{}epsilon2}\PY{p}{)}\PY{p}{,}
  \PY{n}{y} \PY{o}{=} \PY{n+nf}{unique}\PY{p}{(}\PY{n}{likelihood\PYZus{}df}\PY{o}{\PYZdl{}}\PY{n}{sigma\PYZus{}eta2}\PY{p}{)}\PY{p}{,}     
  \PY{n}{z} \PY{o}{=} \PY{n}{likelihood\PYZus{}matrix}\PY{p}{,} 
  \PY{n}{type} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{surface\PYZdq{}}\PY{p}{,}
  \PY{n}{colorscale} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{Inferno\PYZdq{}}
\PY{p}{)}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{T2_FK_files/T2_FK_133_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\tightlist
\item
  estime o modelo de nível Local utilizando a base de dados Nile (
  usando StructTS e DLM) e faça o gráficos usando ggplot2.
\end{enumerate}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{fitNile} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{StructTS}\PY{p}{(}\PY{n}{Nile}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{level\PYZdq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{df} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{data.frame}\PY{p}{(}\PY{n}{Nile\PYZus{}obs} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{Nile}\PY{p}{,}\PY{n}{time}\PY{o}{=}\PY{n+nf}{seq}\PY{p}{(}\PY{l+m}{1}\PY{o}{:}\PY{n+nf}{length}\PY{p}{(}\PY{n}{fitNile}\PY{o}{\PYZdl{}}\PY{n}{fitted}\PY{p}{)}\PY{p}{)}\PY{p}{,}\PY{n}{estimated\PYZus{}level}\PY{o}{\PYZlt{}\PYZhy{}}\PY{n+nf}{fitted}\PY{p}{(}\PY{n}{fitNile}\PY{p}{)}\PY{p}{,}\PY{n}{smoothed}\PY{o}{\PYZlt{}\PYZhy{}}\PY{n+nf}{tsSmooth}\PY{p}{(}\PY{n}{fitNile}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{forecast\PYZus{}obj} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{forecast}\PY{p}{(}\PY{n}{fitNile}\PY{p}{,} \PY{n}{h} \PY{o}{=} \PY{n}{h}\PY{p}{,} \PY{n}{level} \PY{o}{=} \PY{l+m}{90}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n+nb+bp}{T}\PY{o}{=}\PY{n+nf}{length}\PY{p}{(}\PY{n}{fitNile}\PY{o}{\PYZdl{}}\PY{n}{fitted}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{df\PYZus{}pred}\PY{o}{\PYZlt{}\PYZhy{}}\PY{n+nf}{data.frame}\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{prev\PYZsq{}}\PY{o}{=}\PY{n}{forecast\PYZus{}obj}\PY{o}{\PYZdl{}}\PY{n}{mean}\PY{p}{,}\PY{l+s}{\PYZsq{}}\PY{l+s}{lower\PYZsq{}}\PY{o}{=}\PY{n}{forecast\PYZus{}obj}\PY{o}{\PYZdl{}}\PY{n}{lower}\PY{p}{,}\PY{l+s}{\PYZsq{}}\PY{l+s}{upper\PYZsq{}}\PY{o}{=}\PY{n}{forecast\PYZus{}obj}\PY{o}{\PYZdl{}}\PY{n}{upper}\PY{p}{,}\PY{l+s}{\PYZsq{}}\PY{l+s}{time\PYZsq{}}\PY{o}{=}\PY{p}{(}\PY{n+nb+bp}{T}\PY{l+m}{+1}\PY{p}{)}\PY{o}{:}\PY{p}{(}\PY{n+nb+bp}{T}\PY{o}{+}\PY{n}{h}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n+nf}{colnames}\PY{p}{(}\PY{n}{df\PYZus{}pred}\PY{p}{)}\PY{o}{\PYZlt{}\PYZhy{}}\PY{n+nf}{c}\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{prev\PYZsq{}}\PY{p}{,}\PY{l+s}{\PYZsq{}}\PY{l+s}{lower\PYZsq{}}\PY{p}{,}\PY{l+s}{\PYZsq{}}\PY{l+s}{upper\PYZsq{}}\PY{p}{,}\PY{l+s}{\PYZsq{}}\PY{l+s}{time\PYZsq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n+nf}{ggplot}\PY{p}{(}\PY{p}{)} \PY{o}{+} 
\PY{n+nf}{geom\PYZus{}line}\PY{p}{(}\PY{n}{data}\PY{o}{=}\PY{n}{df}\PY{p}{,}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{y} \PY{o}{=} \PY{n}{Nile\PYZus{}obs}\PY{p}{,}\PY{n}{x} \PY{o}{=} \PY{n}{time}\PY{p}{,} \PY{n}{color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{Observed\PYZdq{}}\PY{p}{)}\PY{p}{,} \PY{n}{linewidth} \PY{o}{=} \PY{l+m}{1}\PY{p}{)} \PY{o}{+}
\PY{n+nf}{geom\PYZus{}line}\PY{p}{(}\PY{n}{data}\PY{o}{=}\PY{n}{df}\PY{p}{,}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{y} \PY{o}{=} \PY{n}{smoothed}\PY{p}{,}\PY{n}{x} \PY{o}{=} \PY{n}{time}\PY{p}{,} \PY{n}{color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{Smoothed\PYZdq{}}\PY{p}{)}\PY{p}{,} \PY{n}{linewidth} \PY{o}{=} \PY{l+m}{1}\PY{p}{)} \PY{o}{+}
\PY{n+nf}{geom\PYZus{}line}\PY{p}{(}\PY{n}{data}\PY{o}{=}\PY{n}{df}\PY{p}{,}\PY{n+nf}{aes}\PY{p}{(}\PY{n}{y} \PY{o}{=} \PY{n}{estimated\PYZus{}level}\PY{p}{,}\PY{n}{x} \PY{o}{=} \PY{n}{time}\PY{p}{,} \PY{n}{color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{Estimated Level\PYZdq{}}\PY{p}{)}\PY{p}{,} \PY{n}{linewidth} \PY{o}{=} \PY{l+m}{1}\PY{p}{)} \PY{o}{+}
\PY{n+nf}{geom\PYZus{}line}\PY{p}{(}\PY{n}{data} \PY{o}{=} \PY{n}{df\PYZus{}pred}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{x} \PY{o}{=} \PY{n}{time}\PY{p}{,} \PY{n}{y} \PY{o}{=}\PY{n}{prev}\PY{p}{)}\PY{p}{,} \PY{n}{color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{green\PYZdq{}}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{1}\PY{p}{)} \PY{o}{+}
\PY{n+nf}{geom\PYZus{}ribbon}\PY{p}{(}\PY{n}{data} \PY{o}{=} \PY{n}{df\PYZus{}pred}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{x} \PY{o}{=} \PY{n}{time}\PY{p}{,} \PY{n}{ymin} \PY{o}{=} \PY{n}{lower}\PY{p}{,} \PY{n}{ymax} \PY{o}{=} \PY{n}{upper}\PY{p}{)}\PY{p}{,} \PY{n}{fill} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{green\PYZdq{}}\PY{p}{,} \PY{n}{alpha} \PY{o}{=} \PY{l+m}{0.2}\PY{p}{)}\PY{o}{+}
\PY{n+nf}{scale\PYZus{}color\PYZus{}manual}\PY{p}{(}\PY{n}{values} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{Observed\PYZdq{}} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{black\PYZdq{}}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{Estimated Level\PYZdq{}} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{red\PYZdq{}}\PY{p}{,}\PY{l+s}{\PYZsq{}}\PY{l+s}{Smoothed\PYZsq{}}\PY{o}{=} \PY{l+s}{\PYZsq{}}\PY{l+s}{blue\PYZsq{}}\PY{p}{)}\PY{p}{)} \PY{o}{+}
\PY{n+nf}{labs}\PY{p}{(}
\PY{n}{title} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{Observed Data vs. Estimated Level vs smoothed\PYZdq{}}\PY{p}{,}
\PY{n}{x} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{Time\PYZdq{}}\PY{p}{,}
\PY{n}{y} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{Value\PYZdq{}}\PY{p}{,}
\PY{n}{color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{Legend\PYZdq{}}
\PY{p}{)} \PY{o}{+}
...
\textcolor{ansi-blue}{<ts>}. Defaulting to continuous.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{T2_FK_files/T2_FK_144_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n+nf}{print}\PY{p}{(}\PY{n}{fitNile}\PY{o}{\PYZdl{}}\PY{n}{coef}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{build\PYZus{}states} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{function}\PY{p}{(}\PY{n}{theta}\PY{p}{)} \PY{p}{\PYZob{}}
    \PY{n+nf}{dlmModPoly}\PY{p}{(}\PY{n}{order} \PY{o}{=} \PY{l+m}{1}\PY{p}{,} \PY{n}{dV} \PY{o}{=} \PY{n}{theta}\PY{p}{[}\PY{l+m}{1}\PY{p}{]}\PY{p}{,} \PY{n}{dW} \PY{o}{=} \PY{n}{theta}\PY{p}{[}\PY{l+m}{2}\PY{p}{]}\PY{p}{)}
\PY{p}{\PYZcb{}}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{fitNile} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{dlmMLE}\PY{p}{(}\PY{n}{Nile}\PY{p}{,} \PY{n}{parm} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{l+m}{100}\PY{p}{,} \PY{l+m}{2}\PY{p}{)}\PY{p}{,} \PY{n}{build\PYZus{}states}\PY{p}{,} \PY{n}{lower} \PY{o}{=} \PY{n+nf}{rep}\PY{p}{(}\PY{l+m}{1e\PYZhy{}4}\PY{p}{,} \PY{l+m}{2}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{mod\PYZus{}Nile} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{build\PYZus{}states}\PY{p}{(}\PY{n}{fitNile}\PY{o}{\PYZdl{}}\PY{n}{par}\PY{p}{)}
\PY{n+nf}{drop}\PY{p}{(}\PY{n+nf}{V}\PY{p}{(}\PY{n}{mod\PYZus{}Nile}\PY{p}{)}\PY{p}{)}
\PY{n+nf}{drop}\PY{p}{(}\PY{n+nf}{W}\PY{p}{(}\PY{n}{mod\PYZus{}Nile}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{smooth\PYZus{}Nile} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{dlmSmooth}\PY{p}{(}\PY{n}{Nile}\PY{p}{,} \PY{n}{mod\PYZus{}Nile}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{fore\PYZus{}Nile} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{dlmForecast}\PY{p}{(}\PY{n}{filter\PYZus{}Nile}\PY{p}{,} \PY{n}{nAhead} \PY{o}{=} \PY{l+m}{10}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{f} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{as.numeric}\PY{p}{(}\PY{n}{fore\PYZus{}Nile}\PY{o}{\PYZdl{}}\PY{n}{f}\PY{p}{)}
\PY{n}{Q} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{as.numeric}\PY{p}{(}\PY{n}{fore\PYZus{}Nile}\PY{o}{\PYZdl{}}\PY{n}{Q}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{hwidth} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{qnorm}\PY{p}{(}\PY{l+m}{0.1}\PY{p}{,} \PY{n}{lower} \PY{o}{=} \PY{k+kc}{FALSE}\PY{p}{)} \PY{o}{*} \PY{n+nf}{sqrt}\PY{p}{(}\PY{n+nf}{unlist}\PY{p}{(}\PY{n}{Q}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n+nf}{as.numeric}\PY{p}{(}\PY{p}{(}\PY{n+nf}{length}\PY{p}{(}\PY{n}{Nile}\PY{p}{)} \PY{o}{+} \PY{l+m}{1}\PY{p}{)}\PY{o}{:}\PY{p}{(}\PY{n+nf}{length}\PY{p}{(}\PY{n}{Nile}\PY{p}{)} \PY{o}{+} \PY{l+m}{10}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{df\PYZus{}forecast} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{data.frame}\PY{p}{(}
  \PY{n}{Time} \PY{o}{=} \PY{p}{(}\PY{n+nf}{length}\PY{p}{(}\PY{n}{Nile}\PY{p}{)} \PY{o}{+} \PY{l+m}{1}\PY{p}{)}\PY{o}{:}\PY{p}{(}\PY{n+nf}{length}\PY{p}{(}\PY{n}{Nile}\PY{p}{)} \PY{o}{+} \PY{l+m}{10}\PY{p}{)}\PY{p}{,}
  \PY{n}{Forecasted} \PY{o}{=} \PY{n}{f}\PY{p}{,}
  \PY{n}{Lower} \PY{o}{=} \PY{n}{lower}\PY{p}{,}
  \PY{n}{Upper} \PY{o}{=} \PY{n}{upper}
\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{df} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{data.frame}\PY{p}{(}\PY{n}{time}\PY{o}{=}\PY{n+nf}{time}\PY{p}{(}\PY{n}{smooth\PYZus{}Nile}\PY{o}{\PYZdl{}}\PY{n}{s}\PY{p}{)}\PY{p}{,}\PY{n}{smoothed}\PY{o}{=}\PY{n}{smooth\PYZus{}Nile}\PY{o}{\PYZdl{}}\PY{n}{s}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{df\PYZus{}forecast}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{x} \PY{o}{=} \PY{n}{Time}\PY{p}{)}\PY{p}{)} \PY{o}{+}
  ...
  \PY{c+c1}{\PYZsh{} Adiciona as observações reais da série (y\PYZus{}mnl)}
  \PY{n+nf}{geom\PYZus{}line}\PY{p}{(}\PY{n}{data} \PY{o}{=} \PY{n+nf}{data.frame}\PY{p}{(}\PY{n}{Time} \PY{o}{=} \PY{l+m}{1}\PY{o}{:}\PY{n+nf}{length}\PY{p}{(}\PY{n}{Nile}\PY{p}{)}\PY{p}{,} \PY{n}{Observed} \PY{o}{=} \PY{n}{Nile}\PY{p}{)}\PY{p}{,}
            \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y} \PY{o}{=} \PY{n}{Observed}\PY{p}{,} \PY{n}{color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{Observed\PYZdq{}}\PY{p}{)}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{1}\PY{p}{,} \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{solid\PYZdq{}}\PY{p}{)} \PY{o}{+}
  
  \PY{c+c1}{\PYZsh{} Adiciona a linha de suavização (suavizado)}
  \PY{n+nf}{geom\PYZus{}line}\PY{p}{(}\PY{n}{data} \PY{o}{=} \PY{n+nf}{data.frame}\PY{p}{(}\PY{n}{Time} \PY{o}{=} \PY{l+m}{1}\PY{o}{:}\PY{n+nf}{length}\PY{p}{(}\PY{n}{smooth\PYZus{}mnl}\PY{o}{\PYZdl{}}\PY{n}{s}\PY{p}{[}\PY{l+m}{\PYZhy{}1}\PY{p}{]}\PY{p}{)}\PY{p}{,} \PY{n}{Smoothed} \PY{o}{=} \PY{n}{smooth\PYZus{}mnl}\PY{o}{\PYZdl{}}\PY{n}{s}\PY{p}{[}\PY{l+m}{\PYZhy{}1}\PY{p}{]}\PY{p}{)}\PY{p}{,}
            \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y} \PY{o}{=} \PY{n}{Smoothed}\PY{p}{,} \PY{n}{color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{Smoothed\PYZdq{}}\PY{p}{)}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{1}\PY{p}{,} \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{)} \PY{o}{+}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{T2_FK_files/T2_FK_158_0.png}
    \end{center}
    { \hspace*{\fill} \\}
