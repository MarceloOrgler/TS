...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{Like} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{function}\PY{p}{(}\PY{n}{Parametros}\PY{p}{,} \PY{n}{y}\PY{p}{,} \PY{n}{nb}\PY{p}{,} \PY{n}{np}\PY{p}{,} \PY{n}{nq}\PY{p}{,} \PY{n}{lamb}\PY{p}{,} \PY{n}{x}\PY{p}{,} \PY{n}{Ind}\PY{p}{)} \PY{p}{\PYZob{}}
  
    
  \PY{n}{ny} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{length}\PY{p}{(}\PY{n}{y}\PY{p}{)}
  
  \PY{c+c1}{\PYZsh{} Separating parameters: beta, fi, theta}
  \PY{n+nf}{if }\PY{p}{(}\PY{n}{nb} \PY{o}{\PYZgt{}} \PY{l+m}{0}\PY{p}{)} \PY{p}{\PYZob{}}
    \PY{n}{beta} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{Parametros}\PY{p}{[}\PY{l+m}{1}\PY{o}{:}\PY{n}{nb}\PY{p}{]}
  \PY{p}{\PYZcb{}}
  
  \PY{n}{ar\PYZus{}ma\PYZus{}start} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{nb} \PY{o}{+} \PY{l+m}{1}
  
  \PY{n+nf}{if }\PY{p}{(}\PY{n}{np} \PY{o}{\PYZgt{}} \PY{l+m}{0} \PY{o}{\PYZam{}\PYZam{}} \PY{n}{nq} \PY{o}{==} \PY{l+m}{0}\PY{p}{)} \PY{p}{\PYZob{}}
    \PY{n}{fi} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{Parametros}\PY{p}{[}\PY{n}{ar\PYZus{}ma\PYZus{}start}\PY{o}{:}\PY{p}{(}\PY{n}{ar\PYZus{}ma\PYZus{}start} \PY{o}{+} \PY{n}{np} \PY{o}{\PYZhy{}} \PY{l+m}{1}\PY{p}{)}\PY{p}{]}
  \PY{p}{\PYZcb{}}
  
  \PY{n+nf}{if }\PY{p}{(}\PY{n}{nq} \PY{o}{\PYZgt{}} \PY{l+m}{0} \PY{o}{\PYZam{}\PYZam{}} \PY{n}{np} \PY{o}{==} \PY{l+m}{0}\PY{p}{)} \PY{p}{\PYZob{}}
    \PY{n}{theta} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{Parametros}\PY{p}{[}\PY{n}{ar\PYZus{}ma\PYZus{}start}\PY{o}{:}\PY{p}{(}\PY{n}{ar\PYZus{}ma\PYZus{}start} \PY{o}{+} \PY{n}{nq} \PY{o}{\PYZhy{}} \PY{l+m}{1}\PY{p}{)}\PY{p}{]}
  \PY{p}{\PYZcb{}}
  
  \PY{n+nf}{if }\PY{p}{(}\PY{n}{np} \PY{o}{\PYZgt{}} \PY{l+m}{0} \PY{o}{\PYZam{}\PYZam{}} \PY{n}{nq} \PY{o}{\PYZgt{}} \PY{l+m}{0}\PY{p}{)} \PY{p}{\PYZob{}}
    \PY{n}{fi} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{Parametros}\PY{p}{[}\PY{n}{ar\PYZus{}ma\PYZus{}start}\PY{o}{:}\PY{p}{(}\PY{n}{ar\PYZus{}ma\PYZus{}start} \PY{o}{+} \PY{n}{np} \PY{o}{\PYZhy{}} \PY{l+m}{1}\PY{p}{)}\PY{p}{]}
    \PY{n}{theta} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{Parametros}\PY{p}{[}\PY{p}{(}\PY{n}{ar\PYZus{}ma\PYZus{}start} \PY{o}{+} \PY{n}{np}\PY{p}{)}\PY{o}{:}\PY{p}{(}\PY{n}{ar\PYZus{}ma\PYZus{}start} \PY{o}{+} \PY{n}{np} \PY{o}{+} \PY{n}{nq} \PY{o}{\PYZhy{}} \PY{l+m}{1}\PY{p}{)}\PY{p}{]}
  \PY{p}{\PYZcb{}}
  
  \PY{c+c1}{\PYZsh{} Initialize variables}
  \PY{n}{z}    \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{rep}\PY{p}{(}\PY{l+m}{0}\PY{p}{,} \PY{n}{ny}\PY{p}{)}
  \PY{n}{w}    \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{rep}\PY{p}{(}\PY{l+m}{0}\PY{p}{,} \PY{n}{ny}\PY{p}{)}
  \PY{n}{mi}   \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{rep}\PY{p}{(}\PY{l+m}{0}\PY{p}{,} \PY{n}{ny}\PY{p}{)}
  \PY{n}{erro} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{rep}\PY{p}{(}\PY{l+m}{0}\PY{p}{,} \PY{n}{ny}\PY{p}{)}
  
  \PY{c+c1}{\PYZsh{} First observation: compute w[1]}
  \PY{n+nf}{if }\PY{p}{(}\PY{n}{nb} \PY{o}{==} \PY{l+m}{0}\PY{p}{)} \PY{p}{\PYZob{}}
    \PY{n}{w}\PY{p}{[}\PY{l+m}{1}\PY{p}{]} \PY{o}{\PYZlt{}\PYZhy{}} \PY{l+m}{0}
  \PY{p}{\PYZcb{}} \PY{n}{else} \PY{n+nf}{if }\PY{p}{(}\PY{n}{nb} \PY{o}{==} \PY{l+m}{1}\PY{p}{)} \PY{p}{\PYZob{}}
    \PY{n}{w}\PY{p}{[}\PY{l+m}{1}\PY{p}{]} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{beta}\PY{p}{[}\PY{l+m}{1}\PY{p}{]}
  \PY{p}{\PYZcb{}} \PY{n}{else} \PY{p}{\PYZob{}}
    \PY{n}{w}\PY{p}{[}\PY{l+m}{1}\PY{p}{]} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{beta}\PY{p}{[}\PY{l+m}{1}\PY{p}{]} \PY{o}{+} \PY{n+nf}{as.numeric}\PY{p}{(}\PY{n}{x}\PY{p}{[}\PY{l+m}{1}\PY{p}{,} \PY{l+m}{1}\PY{o}{:}\PY{p}{(}\PY{n}{nb} \PY{o}{\PYZhy{}} \PY{l+m}{1}\PY{p}{)}\PY{p}{]} \PY{o}{\PYZpc{}*\PYZpc{}} \PY{n}{beta}\PY{p}{[}\PY{l+m}{2}\PY{o}{:}\PY{n}{nb}\PY{p}{]}\PY{p}{)}
  \PY{p}{\PYZcb{}}
  
  \PY{n}{mi}\PY{p}{[}\PY{l+m}{1}\PY{p}{]}   \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{exp}\PY{p}{(}\PY{n}{w}\PY{p}{[}\PY{l+m}{1}\PY{p}{]}\PY{p}{)}
  \PY{n}{erro}\PY{p}{[}\PY{l+m}{1}\PY{p}{]} \PY{o}{\PYZlt{}\PYZhy{}} \PY{p}{(}\PY{n}{y}\PY{p}{[}\PY{l+m}{1}\PY{p}{]} \PY{o}{\PYZhy{}} \PY{n}{mi}\PY{p}{[}\PY{l+m}{1}\PY{p}{]}\PY{p}{)} \PY{o}{/} \PY{p}{(}\PY{n}{mi}\PY{p}{[}\PY{l+m}{1}\PY{p}{]}\PY{o}{\PYZca{}}\PY{n}{lamb}\PY{p}{)}
  \PY{n}{L}       \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{y}\PY{p}{[}\PY{l+m}{1}\PY{p}{]} \PY{o}{*} \PY{n}{w}\PY{p}{[}\PY{l+m}{1}\PY{p}{]} \PY{o}{\PYZhy{}} \PY{n+nf}{exp}\PY{p}{(}\PY{n}{w}\PY{p}{[}\PY{l+m}{1}\PY{p}{]}\PY{p}{)}
  
  \PY{c+c1}{\PYZsh{} Loop over t = 2 to ny}
  \PY{n+nf}{for }\PY{p}{(}\PY{n}{t} \PY{n}{in} \PY{l+m}{2}\PY{o}{:}\PY{n}{ny}\PY{p}{)} \PY{p}{\PYZob{}}
    
    \PY{c+c1}{\PYZsh{} AR component}
    \PY{n+nf}{if }\PY{p}{(}\PY{n}{np} \PY{o}{\PYZgt{}} \PY{l+m}{0}\PY{p}{)} \PY{p}{\PYZob{}}
      \PY{n+nf}{for }\PY{p}{(}\PY{n}{k} \PY{n}{in} \PY{l+m}{1}\PY{o}{:}\PY{n+nf}{min}\PY{p}{(}\PY{n}{np}\PY{p}{,} \PY{n}{t} \PY{o}{\PYZhy{}} \PY{l+m}{1}\PY{p}{)}\PY{p}{)} \PY{p}{\PYZob{}}
        \PY{n}{z}\PY{p}{[}\PY{n}{t}\PY{p}{]} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{z}\PY{p}{[}\PY{n}{t}\PY{p}{]} \PY{o}{+} \PY{n}{fi}\PY{p}{[}\PY{n}{k}\PY{p}{]} \PY{o}{*} \PY{p}{(}\PY{n}{z}\PY{p}{[}\PY{n}{t} \PY{o}{\PYZhy{}} \PY{n}{k}\PY{p}{]} \PY{o}{+} \PY{n}{erro}\PY{p}{[}\PY{n}{t} \PY{o}{\PYZhy{}} \PY{n}{k}\PY{p}{]}\PY{p}{)}
      \PY{p}{\PYZcb{}}
    \PY{p}{\PYZcb{}}
    
    \PY{c+c1}{\PYZsh{} MA component}
    \PY{n+nf}{if }\PY{p}{(}\PY{n}{nq} \PY{o}{\PYZgt{}} \PY{l+m}{0}\PY{p}{)} \PY{p}{\PYZob{}}
      \PY{n+nf}{for }\PY{p}{(}\PY{n}{k} \PY{n}{in} \PY{l+m}{1}\PY{o}{:}\PY{n+nf}{min}\PY{p}{(}\PY{n}{nq}\PY{p}{,} \PY{n}{t} \PY{o}{\PYZhy{}} \PY{l+m}{1}\PY{p}{)}\PY{p}{)} \PY{p}{\PYZob{}}
        \PY{n}{z}\PY{p}{[}\PY{n}{t}\PY{p}{]} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{z}\PY{p}{[}\PY{n}{t}\PY{p}{]} \PY{o}{+} \PY{n}{theta}\PY{p}{[}\PY{n}{k}\PY{p}{]} \PY{o}{*} \PY{n}{erro}\PY{p}{[}\PY{n}{t} \PY{o}{\PYZhy{}} \PY{n}{k}\PY{p}{]}
      \PY{p}{\PYZcb{}}
    \PY{p}{\PYZcb{}}
    
    \PY{c+c1}{\PYZsh{} Compute w[t] based on z[t] and x[t,]}
    \PY{n+nf}{if }\PY{p}{(}\PY{n}{nb} \PY{o}{==} \PY{l+m}{0}\PY{p}{)} \PY{p}{\PYZob{}}
      \PY{n}{w}\PY{p}{[}\PY{n}{t}\PY{p}{]} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{z}\PY{p}{[}\PY{n}{t}\PY{p}{]}
    \PY{p}{\PYZcb{}} \PY{n}{else} \PY{n+nf}{if }\PY{p}{(}\PY{n}{nb} \PY{o}{==} \PY{l+m}{1}\PY{p}{)} \PY{p}{\PYZob{}}
      \PY{n}{w}\PY{p}{[}\PY{n}{t}\PY{p}{]} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{beta}\PY{p}{[}\PY{l+m}{1}\PY{p}{]} \PY{o}{+} \PY{n}{z}\PY{p}{[}\PY{n}{t}\PY{p}{]}
    \PY{p}{\PYZcb{}} \PY{n}{else} \PY{p}{\PYZob{}}
      \PY{n}{w}\PY{p}{[}\PY{n}{t}\PY{p}{]} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{beta}\PY{p}{[}\PY{l+m}{1}\PY{p}{]} \PY{o}{+} \PY{n+nf}{as.numeric}\PY{p}{(}\PY{n}{x}\PY{p}{[}\PY{n}{t}\PY{p}{,} \PY{l+m}{1}\PY{o}{:}\PY{p}{(}\PY{n}{nb} \PY{o}{\PYZhy{}} \PY{l+m}{1}\PY{p}{)}\PY{p}{]} \PY{o}{\PYZpc{}*\PYZpc{}} \PY{n}{beta}\PY{p}{[}\PY{l+m}{2}\PY{o}{:}\PY{n}{nb}\PY{p}{]}\PY{p}{)} \PY{o}{+} \PY{n}{z}\PY{p}{[}\PY{n}{t}\PY{p}{]}
    \PY{p}{\PYZcb{}}
    
    \PY{n}{mi}\PY{p}{[}\PY{n}{t}\PY{p}{]}   \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{exp}\PY{p}{(}\PY{n}{w}\PY{p}{[}\PY{n}{t}\PY{p}{]}\PY{p}{)}
    \PY{n}{erro}\PY{p}{[}\PY{n}{t}\PY{p}{]} \PY{o}{\PYZlt{}\PYZhy{}} \PY{p}{(}\PY{n}{y}\PY{p}{[}\PY{n}{t}\PY{p}{]} \PY{o}{\PYZhy{}} \PY{n}{mi}\PY{p}{[}\PY{n}{t}\PY{p}{]}\PY{p}{)} \PY{o}{/} \PY{p}{(}\PY{n}{mi}\PY{p}{[}\PY{n}{t}\PY{p}{]}\PY{o}{\PYZca{}}\PY{n}{lamb}\PY{p}{)}
    \PY{n}{L}       \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{L} \PY{o}{+} \PY{n}{y}\PY{p}{[}\PY{n}{t}\PY{p}{]} \PY{o}{*} \PY{n}{w}\PY{p}{[}\PY{n}{t}\PY{p}{]} \PY{o}{\PYZhy{}} \PY{n+nf}{exp}\PY{p}{(}\PY{n}{w}\PY{p}{[}\PY{n}{t}\PY{p}{]}\PY{p}{)}
  \PY{p}{\PYZcb{}}
  
  \PY{n}{L} \PY{o}{\PYZlt{}\PYZhy{}} \PY{o}{\PYZhy{}}\PY{n}{L}  \PY{c+c1}{\PYZsh{} negative log\PYZhy{}likelihood}
  
  \PY{n}{valores} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{cbind}\PY{p}{(}\PY{n}{erro}\PY{p}{,} \PY{n}{z}\PY{p}{,} \PY{n}{mi}\PY{p}{)}
  
  \PY{n+nf}{if }\PY{p}{(}\PY{n}{Ind} \PY{o}{==} \PY{l+m}{0}\PY{p}{)} \PY{n+nf}{return}\PY{p}{(}\PY{n}{L}\PY{p}{)}
  \PY{n+nf}{if }\PY{p}{(}\PY{n}{Ind} \PY{o}{==} \PY{l+m}{1}\PY{p}{)} \PY{n+nf}{return}\PY{p}{(}\PY{n}{valores}\PY{p}{)}
\PY{p}{\PYZcb{}}
\end{Verbatim}
\end{tcolorbox}
