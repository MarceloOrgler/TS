...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{hwidth} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{qnorm}\PY{p}{(}\PY{l+m}{0.95}\PY{p}{)} \PY{o}{*} \PY{n+nf}{sqrt}\PY{p}{(}\PY{n+nf}{unlist}\PY{p}{(}\PY{n}{Q}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n+nf}{labs}\PY{p}{(}\PY{n}{title} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{Modelo de Nivel Local: Erro de previsao\PYZdq{}}\PY{p}{,}
...
\PY{n}{logLik\PYZus{}mnl} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{function}\PY{p}{(}\PY{n}{theta}\PY{p}{)} \PY{p}{\PYZob{}}
  ...
  \PY{n}{fk\PYZus{}results} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{mnl\PYZus{}fk}\PY{p}{(}\PY{n+nb+bp}{T} \PY{o}{=} \PY{n+nf}{length}\PY{p}{(}\PY{n}{y\PYZus{}mnl}\PY{p}{)}\PY{p}{,}\PY{n}{y\PYZus{}mnl}\PY{p}{,} \PY{n}{sigma\PYZus{}epsilon2}\PY{p}{,} \PY{n}{sigma\PYZus{}eta2}\PY{p}{,} \PY{n}{a0} \PY{o}{=} \PY{l+m}{0}\PY{p}{,} \PY{n}{p0} \PY{o}{=} \PY{l+m}{100}\PY{p}{)}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{T2_FK_files/T2_FK_132_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\textcolor{ansi-blue}{<ts>}. Defaulting to continuous.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{T2_FK_files/T2_FK_143_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\PY{n}{filter\PYZus{}Nile} \PY{o}{\PYZlt{}\PYZhy{}}\PY{n+nf}{dlmFilter}\PY{p}{(}\PY{n}{Nile}\PY{p}{,}\PY{n}{mod\PYZus{}Nile}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n+nf}{ggplot}\PY{p}{(}\PY{n}{df\PYZus{}forecast}\PY{p}{,} \PY{n+nf}{aes}\PY{p}{(}\PY{n}{x} \PY{o}{=} \PY{n}{Time}\PY{p}{)}\PY{p}{)} \PY{o}{+}
  ...
  \PY{c+c1}{\PYZsh{} Adiciona a linha de suavização (suavizado)}
  \PY{n+nf}{geom\PYZus{}line}\PY{p}{(}\PY{n}{data} \PY{o}{=} \PY{n+nf}{data.frame}\PY{p}{(}\PY{n}{Time} \PY{o}{=} \PY{l+m}{1}\PY{o}{:}\PY{n+nf}{length}\PY{p}{(}\PY{n}{smooth\PYZus{}Nile}\PY{o}{\PYZdl{}}\PY{n}{s}\PY{p}{[}\PY{l+m}{\PYZhy{}1}\PY{p}{]}\PY{p}{)}\PY{p}{,} \PY{n}{Smoothed} \PY{o}{=} \PY{n}{smooth\PYZus{}Nile}\PY{o}{\PYZdl{}}\PY{n}{s}\PY{p}{[}\PY{l+m}{\PYZhy{}1}\PY{p}{]}\PY{p}{)}\PY{p}{,}
            \PY{n+nf}{aes}\PY{p}{(}\PY{n}{y} \PY{o}{=} \PY{n}{Smoothed}\PY{p}{,} \PY{n}{color} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{Smoothed\PYZdq{}}\PY{p}{)}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m}{1}\PY{p}{,} \PY{n}{linetype} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{dashed\PYZdq{}}\PY{p}{)} \PY{o}{+}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{T2_FK_files/T2_FK_155_0.png}
    \end{center}
    { \hspace*{\fill} \\}
